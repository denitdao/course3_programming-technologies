...
class RightSleeveServiceTest {
    ...
    @Test
    public void createNewRightSleeveShouldReturnRightSleeve() {
        RightSleeve rightSleeve = rightSleeveService.create();

        assertNotNull(rightSleeve);
    }

    @Test
    public void editRightSleeveShouldSetNotNull(){
        RightSleeve rightSleeve = new RightSleeve();

        rightSleeveService.edit(rightSleeve);
