...
class UpperBodyClothesServiceIT {
    ...
    Size defSize = Size.L;
    Double defPrice = 80.;
    LeftSleeve defLeftSleeve = new LeftSleeve(Material.COTTON, Color.BLUE, Length.LONG);
    RightSleeve defRightSleeve = new RightSleeve(Material.COTTON, Color.BLUE, Length.LONG);
